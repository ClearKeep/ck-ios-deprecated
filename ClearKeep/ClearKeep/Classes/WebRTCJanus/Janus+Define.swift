...
typealias FailureCallback = (Error) -> ()
typealias CompleteCallback = (Bool, Error?) -> ()
typealias AttachCallback = (NSNumber, Error?) -> ()
typealias DetachCallback = (Error?) -> ()
typealias PluginRequestCallback = ([String: Any], [String: Any]?) -> ()
typealias JanusRequestCallback = ([String: Any]) -> ()
